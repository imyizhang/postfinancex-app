...
# Tableau embed code
TABLEAU_EMBED_CODE = """<div class='tableauPlaceholder' id='viz1716650958736' style='position: relative'>
    <noscript>
        ...
        <param name='name' value='IBMDashboard_17165757578990&#47;Dashboard' />
...
<script type='text/javascript'>
    ...
    divElement.style.position = "relative"; divElement.appendChild(hider)
</script>"""
