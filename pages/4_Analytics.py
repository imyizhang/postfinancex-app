...
# Tableau embed code
tableau_embed_code = """<div class='tableauPlaceholder' id='viz1716650958736' style='position: relative'><noscript>
                        ...
                        <param name='name' value='IBMDashboard_17165757578990&#47;Dashboard' /><param name='tabs' value='no' />
                        ...
                        <param name='display_count' value='yes' /><param name='language' value='en-GB' /></object>
